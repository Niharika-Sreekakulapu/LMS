...
import { downloadReport as downloadAdminReport } from "../api/adminApi";
import { downloadReport as downloadLibraryReport } from "../api/libraryApi";
...
export default function Reports() {
  ...
  const handleDownload = async (reportType: string, format: 'csv' | 'excel') => {
    ...
    try {
      ...
      const downloadReport = auth.user?.role === 'ADMIN' ? downloadAdminReport : downloadLibraryReport;
